...
router.get('/manager', authenticate, authorize('manager', 'teamlead'), async (req, res) => {
  try {
    // Add your dashboard data fetching logic here
    res.json({
      teamStats: {
...
router.get('/marketing', authenticate, authorize('marketing'), async (req, res) => {
  try {
...
router.get('/support', authenticate, authorize('support'), async (req, res) => {
  try {
...
router.get('/staff', authenticate, authorize('staff'), async (req, res) => {
  try {
