...
import { ArrowRight, CheckCircle, Users, TrendingUp, Shield, Zap, Sparkles } from 'lucide-react';
          ...
          <motion.div initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }}>
            <motion.div
              ...
              style={{
                ...
                border: `1px solid ${theme.colors.golden[400]}`,
              }}
            >
              <Sparkles size={16} style={{ color: theme.colors.golden[500] }} />
            ...
            >
              <Link
                ...
                style={{
                  ...
                  background: `linear-gradient(135deg, ${theme.colors.golden[500]}, ${theme.colors.orange[600]})`,
                ...
                onMouseEnter={(e) => {
                  ...
                  e.target.style.boxShadow = `0 12px 48px rgba(255, 165, 0, 0.4)`;
                }}
                onMouseLeave={(e) => {
              ...
              <Link
                ...
                style={{
                  ...
                  color: theme.colors.text.inverse,
                  border: `2px solid ${theme.colors.golden[400]}`,
                  borderRadius: theme.borderRadius.lg,
                  textDecoration: 'none',
                ...
                onMouseEnter={(e) => {
                  ...
                  e.target.style.borderColor = theme.colors.orange[400];
                }}
                onMouseLeave={(e) => {
                  e.target.style.background = 'transparent';
                  e.target.style.borderColor = theme.colors.golden[400];
                }}
              >
            ...
            >
              {['✓ 1:1 Human Counsellors', '✓ Data Kept Private & Secure', '✓ RBI Compliant'].map((item, i) => (
                <div key={i}>{item}</div>
              ))}
            </motion.div>
          </motion.div>
              ...
              return (
                <motion.div
                  ...
                  style={{
                    ...
                    background: `linear-gradient(135deg, rgba(255, 165, 0, 0.15), rgba(255, 153, 0, 0.08))`,
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.background = `linear-gradient(135deg, rgba(255, 165, 0, 0.25), rgba(255, 153, 0, 0.15))`;
                    e.currentTarget.style.borderColor = theme.colors.orange[400];
                    e.currentTarget.style.transform = 'translateY(-4px)';
                    e.currentTarget.style.boxShadow = `0 8px 32px rgba(255, 165, 0, 0.25)`;
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.background = `linear-gradient(135deg, rgba(255, 165, 0, 0.15), rgba(255, 153, 0, 0.08))`;
                    e.currentTarget.style.borderColor = theme.colors.golden[400];
                ...
                >
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
                    <div>
                      <p style={{ fontSize: theme.typography.fontSizes.xs, opacity: 0.8, marginBottom: theme.spacing.sm, textTransform: 'uppercase', color: theme.colors.golden[300] }}>
                        {stat.label}
                      </p>
                      <p style={{ fontSize: theme.typography.fontSizes['2xl'], fontWeight: theme.typography.fontWeights.bold, background: `linear-gradient(90deg, ${theme.colors.golden[300]}, ${theme.colors.orange[300]})`, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
                        {stat.prefix}
                        {stat.value}
                        {stat.suffix}
                      </p>
                    ...
                    <div
                      style={{
                        ...
                        background: `linear-gradient(135deg, ${theme.colors.orange[500]}, ${theme.colors.golden[500]})`,
                        borderRadius: theme.borderRadius.lg,
                        display: 'flex',
                        alignItems: 'center',
      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <Link
            ...
            onMouseEnter={(e) => {
              e.target.style.transform = 'scale(1.05) translateY(-2px)';
              e.target.style.boxShadow = `0 12px 48px rgba(255, 165, 0, 0.5)`;
            }}
            onMouseLeave={(e) => {
              e.target.style.transform = 'scale(1)';
              e.target.style.boxShadow = `0 8px 32px rgba(255, 165, 0, 0.4)`;
            }}
          >
